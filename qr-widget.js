/**
 * QR-Generator Widget – webhook + branch_id (eine Datei für Softr/GitHub).
 * Ruft auf: {webhook}_qrcode, {webhook}_branches, {webhook}_qr_status
 *
 * Softr: Diesen Block einfügen (data-Attribute, kein Inline-Script):
 * <script src="https://cdn.jsdelivr.net/gh/t2thak/bilderspeicher@main/qr-widget.js" data-webhook="justai" data-branch-id="DEINE-BRANCH-ID" data-webhook-base="https://n8nv2.flowrk.io/webhook/" data-language="de"></script>
