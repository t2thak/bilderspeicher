...
(function () {
  ...
  function init() {
    ...
    console.log('[QR-Frontend v1.9] Language:', language, 'Sources: container=' + containerLang + ', script=' + langFromCur + ', override=' + window.QR_FRONTEND_LANGUAGE);
    ...
    function runApp() {
      ...
      console.log('[QR-Frontend v1.9] App started');
