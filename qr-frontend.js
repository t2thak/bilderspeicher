...
(function () {
  ...
  function init() {
    ...
    console.log('[QR-Frontend v1.7] Language detected:', language, 'Override:', window.QR_FRONTEND_LANGUAGE);
    ...
    function runApp() {
      ...
      console.log('[QR-Frontend v1.7] App started');
