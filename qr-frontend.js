...
(function () {
  ...
  function init() {
    ...
    console.log('[QR-Frontend v1.8 DEBUG] containerLang:', containerLang, 'langFromCur:', langFromCur, 'window.QR_FRONTEND_LANGUAGE:', window.QR_FRONTEND_LANGUAGE);

    // FORCE GERMAN - IGNORE ALL OTHER INPUTS
    // This is a temporary fix to diagnose why Vietnamese keeps appearing
    language = 'de';

    console.log('[QR-Frontend v1.8 FORCE DE] Language FORCED to:', language);
    T = TRANSLATIONS.de; // Use German directly, don't even check language variable
    try { window.QR_FRONTEND_LANG = 'de'; } catch (e) { }
    ...
    function runApp() {
      ...
      console.log('[QR-Frontend v1.8] App started');
